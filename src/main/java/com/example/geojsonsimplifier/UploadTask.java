...
public class UploadTask implements DeferredTask {

 public static volatile String gj;
 public String group; 
 public String username; 

 public UploadTask(String group,String username) {
  this.gj=gj;
  this.group=group;
   ...
   for (int i = 0; i < jsonString.features.size(); i++) {
    ...
    if (jsonString.features.get(i).geometry != null) {
     ...
     for (int n = 0; n < 8; n++) {
      ...
      geoJsonEntity.setProperty("geometryCoordinateSimplified" + n, simplify(stringCoordinate, n, featureType));
...
//This method handles the simplification of different geometry types: Polygon and MultiPolygon
 private Text simplify(String featureCoordinates, int nSimplifications, String type) {
