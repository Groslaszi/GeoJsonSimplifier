...
public class Greetings {
  ...
  public HelloGreeting listDataSets(@Named("group") String group, @Named("zoom") int zoom, @Named("username") String username) throws NotFoundException {
...
private int levelSimplification(int zoom, int screen){
    ...
    switch (levelToFetch){
      case 100:  levelToFetch = 1;
      break;
      case 200:  levelToFetch = 2;
      break;
      case 300:  levelToFetch = 3;
      break;
      case 400:  levelToFetch = 4;
      break;
      case 500:  levelToFetch = 5;
      break;
      case 600:  levelToFetch = 6;
      break;
      case 700:  levelToFetch = 7;
      break;   
      case 800:  levelToFetch = 8;
      break;     
